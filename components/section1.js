    ...
    return (
        <div className="grid md:grid-cols-2">
            ...
            <div className="info flex justify-center flex-col">
                ...
                <div className="title">
                    <Link href={"/"} className="text-blue-400 text-4xl font-bold hover:text-orange-400">Totally accurate survey: Every 1 out of 10 students is a victim of forgetting to turn in their assignment in GCR</Link>
                </div>
